  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = typeof data === 'string'
        ? data
        : data?.detail || data?.message || data?.username?.[0] || data?.email?.[0] || data?.password?.[0] || 'Registration failed';
      toast.error(msg);
    } finally {
      setLoading(false);
    }
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`input-primary pr-10 ${errors.password ? 'border-red-500 focus:ring-red-500' : ''}`}
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`input-primary pr-10 ${errors.confirmPassword ? 'border-red-500 focus:ring-red-500' : ''}`}
                placeholder="••••••••"
              />
              <button
                type="button"
